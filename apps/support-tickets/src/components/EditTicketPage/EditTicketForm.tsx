...
import { useUpdateEntity, useUser } from "@replyke/react-js";
      ...
      await updateEntity({
        ...
        update: {
          ...
          metadata: {
            ...
            priority: showPriority ? formData.priority || null : ticket.metadata.priority,
          },
        },
      });

      toast.success("Ticket updated successfully!");
      router.push(`/tickets/${ticket.shortId}`);
    } catch (error) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex gap-3">
        ...
        <Button
          type="button"
          variant="outline"
          onClick={() => router.push(`/tickets/${ticket.shortId}`)}
